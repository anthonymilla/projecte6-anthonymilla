...
Al repositori del projecte dins la carpeta corresponent a la tasca, heu lliurar la següent feina:
...
- Procediment creació certificat client.

- Instal·lació clau CA al client.

- Instal·lació certificat client.

- Procediment signatura document PDF i comprovació.

- Breu explicació de les diferències entre una Clau Pública i una Clau Privada en aquest procés.

## Evidència de la signatura

El fitxer PDF de prova de Nexus signat digitalment per un dels membres del grup (s’haurà d’adjuntar al repositori).

## Certificat arrel

El fitxer .cer de la vostra Autoritat de Certificació (la clau pública de la CA), també s’haurà d'incloure al repositori per poder ser descarregat.
